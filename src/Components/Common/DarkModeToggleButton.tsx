...
function DarkModeToggleButton() {
  ...
  return (
    <div className="btn-mode btn btn-square btn-ghost w-12 h-10 rounded-lg" role="presentation" data-set-theme={isDarkMode ? THEME_LIGHT : THEME_DARK} onClick={() => handleTheme()}>
      {isDarkMode ? (
        // sun icon
